---
title: "models_pdf.rmd"
author: "Billiau/Eng/Li"
date: "12/6/2019"
output: pdf_document
---
...
Model 3 - Mixed Model, fixed effect of time, random slopes and intercept stratified on School
...
## SEGMENTED REGRESSION with OLS
Using the segmented package to explore segmenting the OLS model 
...
### Mixed model - segmented, unsuccessful aside exploring teams
Unsuccessful Aside playing around with same coach
